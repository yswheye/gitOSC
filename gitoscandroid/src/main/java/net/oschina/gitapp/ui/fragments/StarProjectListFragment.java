 ...
 * 更新者
 */
public class StarProjectListFragment extends BaseSwipeRefreshFragment<Project, CommonList<Project>> {
	...
	public MessageData<CommonList<Project>> asyncLoadList(int page,
		...
		try {
			CommonList<Project> list = mApplication.getStarProjectList(mUser.getId(), page, refresh);
