...
public class L {
	...
	public static String getDeviceInfo(Context context) {
		...
		try {
			...
			builder.append("VERSION_CODES.BASE ").append(android.os.Build.VERSION_CODES.BASE)
			       .append("\n");
			builder.append("VERSION.RELEASE ").append(android.os.Build.VERSION.RELEASE)
			       .append("\n");
			builder.append("SDK").append(android.os.Build.VERSION.SDK_INT).append("\n");
		} catch (Exception e) {
		}
