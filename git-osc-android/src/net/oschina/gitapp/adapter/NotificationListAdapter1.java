 ...
 * @reason 改用分类的适配器
 */
public class NotificationListAdapter1 extends BaseExpandableListAdapter {
	...
	public NotificationListAdapter1(Context context, List<List<Notification>> data, List<String> mGroupStrings) {
